...
# Histogram to show data distribution of "Global Active Power" 
hist(power_consump.12$Global_active_power, col = "red", xlab = "Global Active Power (kilowatts)", main = "Global Active Power")
dev.off()
